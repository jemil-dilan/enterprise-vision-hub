      ...
      <div className="pt-20 pb-16">
        <div className="bg-primary/5 py-8">
          <div className="container mx-auto px-4">
            ...
            <h1 className="text-3xl font-heading font-bold text-foreground">Finaliser la Commande</h1>
            <p className="text-muted-foreground text-sm mt-1">Étape 1 sur 2 — Informations de livraison</p>
          </div>
        </div>
            ...
            >
              ...
              <div className="bg-card rounded-lg shadow-card p-6 space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea id="notes" name="notes" value={form.notes} onChange={handleChange} placeholder="Instructions spéciales..." rows={3} />
                </div>
              </div>
